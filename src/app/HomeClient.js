...
export default function HomeClient({ 
  ...
  const [homepageSettings, setHomepageSettings] = useState(() => {
    if (initialHomepageSettings) {
      return {
        slidesSection: { ...defaultHomepage.slidesSection, ...initialHomepageSettings.slidesSection },
        trendingSection: { ...defaultHomepage.trendingSection, ...initialHomepageSettings.trendingSection },
        middleBanner: { ...defaultHomepage.middleBanner, ...initialHomepageSettings.middleBanner }
      };
    }
  ...
  const [activeTab, setActiveTab] = useState(() => {
    if (initialHomepageSettings?.trendingSection?.tabs?.length > 0) {
      return initialHomepageSettings.trendingSection.tabs[0].id;
    }
    return 'new-arrivals';
  });
  ...
  return (
    <div>
      ...
      <section className="fluid-container" style={{ padding: '40px 15px', maxWidth: '1400px', margin: '0 auto' }}>
        ...
        >
          <h2 style={{ fontSize: '24px', fontWeight: '400', marginBottom: '12px', color: '#222' }}>Step into Style with Shuz New Arrivals</h2>
          <p style={{ marginBottom: '25px' }}>For those who love footwear, we at Shuz always have something original and interesting to present. Our <strong>New Arrivals</strong> section brings you the newest trends, modern styles, and daily comfort all in one place. Styles selected are carefully chosen to satisfy both everyday needs and current street trends. Whether you want striking alternatives for special events or casual pairs for everyday wear, our New Arrivals span everything. There are fashionable Slides, Runners, Spezial, Sambas, Sneakers, Bad Bunny, and Puma lines for every way of life. Frequent changes in this area guarantee you never lose sight of current market trends. Every pair combines style and utility so that you feel at ease at the same time and look good. We place quality, longevity, and intelligent pricing first in <strong>Shuz.</strong> Customers depend on our New Arrivals daily for dependable style and long-lasting comfort.</p>

          <h2 style={{ fontSize: '24px', fontWeight: '400', marginBottom: '12px', color: '#222' }}>Standout Designs Based on Trend</h2>
          <p style={{ marginBottom: '25px' }}>Our <strong>New Arrivals</strong> reflect the latest global fashion trends. We follow what people love and deliver those styles straight to Shuz. Vibrant colors, modern shapes, and crisp details help you stand out confidently. Every design adds personality to your wardrobe and keeps your look fresh and stylish.</p>
